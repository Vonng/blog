...
People praise the cloud as carefree, with managed services easing every pain.<br/>
I say clouds are pig-butchering schemes, hundredfold markups with smug disdain.<br/>
Cyber landlords hold monopolies, hike the price, extract your vein.<br/>
They outsource ops, freeload on OSS, rent you servers, rebrand the game.<br/>
Everyone rushes to the cloud, burning cash like pouring rain.<br/>
Sky-high rentals can’t be borne; self-hosted OSS is still the sane.<br/>
Downcloud pioneers clear the way, shouldering doubt and market strain.<br/>
...
- [DHH: Leaving the cloud saved us an extra $100M](https://mp.weixin.qq.com/s/mknFXO5DSfxw7st8hhxjBQ)
- [Downcloud Odyssey: Is it time to leave the cloud?](https://mp.weixin.qq.com/s/CicctyvV1xk5B-AsKfzPjw)
...
- [Global Windows bluescreen: both sides were clown brigades](https://mp.weixin.qq.com/s/s7i7bSYzNY8mrcpfkHPjOg)

------

## Core Resources

- [Real cost of cloud compute](https://mp.weixin.qq.com/s/rp8Dtvyo9cItBJSsvfrKjw)
- [Object storage: from discounts to pig butchering](https://mp.weixin.qq.com/s/HathxpQ_KUuqxyrtyCDzWw)
...
- [Alibaba DCDN: 32 seconds, ¥1,600 bill](https://mp.weixin.qq.com/s/0Wnv1B80Tk4J03X3uAm4Ww)

------

## Business Models

- [Will DBAs be replaced by the cloud?](https://mp.weixin.qq.com/s/W1hwbl3qmjC4Dcmadc8uSg)
- [FinOps ends with leaving the cloud](https://mp.weixin.qq.com/s/Yp_PU8nmyK-NVq0clD98RQ)
- [Why haven’t domestic clouds dug up “sand money” yet?](https://mp.weixin.qq.com/s/2w0bLJI7TvUNp1tzLYbvsA)
- [Are cloud SLAs comfort blankets?](https://mp.weixin.qq.com/s/LC5jAhuVObRcrTLxI1FUQA)
...
- [Are cloud databases pig-butchering schemes?](https://mp.weixin.qq.com/s/LefEAXTcBH-KBJNhXNoc7A)
- [Myth of HA/DR](https://mp.weixin.qq.com/s/rXwEayprvDKCgba4m-naoQ)
- [Cloud RDS amputated PostgreSQL’s soul](https://mp.weixin.qq.com/s/EH7RPB6ImfMHXhOMU7P5Qg)
- [Cloud RDS: from dropping tables to skipping town](https://mp.weixin.qq.com/s/AGEW1iHQkQy4NQyYC2GonQ)
- [Rebuttal: “Why you shouldn’t hire DBAs (again)”](https://mp.weixin.qq.com/s/CMRrqI2yBWlNbACHpNgL1g)

------

## Satire & Portraits

- [Sexologists, chemists, and software BS artists](https://mp.weixin.qq.com/s/qAnEmtLz3EpSophz1TbFGA)
- [Toothpaste cloud? Stop praising vendors](https://mp.weixin.qq.com/s/XZqe4tbJ9lgf8a6PWj7vjw)
- [Internet tech master crash course](https://mp.weixin.qq.com/s/8ZffsCgchv8LH5ujv0lRGQ)
- [Clown crews behind Internet outages](https://mp.weixin.qq.com/s/OxhhJ4U1P43di_eaE1uGPw)
- [How cloud vendors see customers: broke, bored, needy](https://mp.weixin.qq.com/s/y9IradwxTxOsUGcOHia1XQ)
