...
![Claude Code token usage](usage.webp)
...
![Subscription economics and effective subsidy](featured.webp)
...
![Claude Max pricing](pricing.webp)
...
![Shadow API paper on deceptive model claims](paper.webp)
...
![Overview of high-value AI output](output.webp)
...
![Recent output highlights](highlights.webp)
...
![Alex Karp warning about AI and the state](karp.webp)

![Further commentary on the policy window](policy.webp)
...
![Cost estimate for local large-model clusters](cluster.webp)
...
![Discussion around account bans and risk controls](ban.webp)
...
![Early-adopter window for AI engineering](window.webp)
