...
date: 2024-12-23
author: vonng 
summary: PostgreSQL 与 Pigsty 中长期缺失的一个包管理器 —— PIG
tags: [PostgreSQL,工具]
---
...
我在 《[**把 PostgreSQL 放入 Docker 是一个好主意**](/db/pg-in-docker)**吗**》这篇文章中深入聊过这个问题，其中特别提到过扩展的问题。总的来说，会遇到：扩展持久化的问题，安装扩展需要重新构建镜像，推送并重启的问题，难以同时组合使用扩展的问题。
